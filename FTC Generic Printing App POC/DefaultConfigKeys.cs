...
{
    internal static class DefaultConfigKeys
    {
        public const string CONFIG_DEFAULT_STORES_API_AUTH_URL = "configDefaultStoresApiAuthUrl";
        public const string CONFIG_DEFAULT_STORES_API_URL = "configDefaultStoresApiUrl";
